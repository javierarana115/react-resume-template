...
const SvgIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fill="#f90" fillRule="evenodd" clipRule="evenodd">
      ...
      <path d="M287.2 128.1c-4.2-5.4-27.8-2.6-38.5-1.3-3.2.4-3.7-2.4-.8-4.5 18.8-13.2 49.7-9.4 53.3-5 3.6 4.5-1 35.4-18.6 50.2-2.7 2.3-5.3 1.1-4.1-1.9 4-9.9 12.9-32.2 8.7-37.5"></path>
    </g>
  </svg>
);
